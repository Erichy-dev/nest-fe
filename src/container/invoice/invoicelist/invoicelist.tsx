                        ...
                        <Card className="custom-card">
                            <Card.Header className="card-header justify-content-between">
                                ...
                                <div className="d-flex">
                                    <Link to={`${import.meta.env.BASE_URL}invoice/create`}>
                                    ...
                                    <Table className="table text-nowrap table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr className="invoice-list" key={Math.random()}>
                                                ...
                                                <td>
                                                    <Link to={`${import.meta.env.BASE_URL}invoice/details`} className="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light me-1">
