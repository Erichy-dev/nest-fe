                                        ...
                                        <Card.Body>
                                            ...
                                            <div className="fw-semibold fs-18 text-fixed-white mb-2">
                                                ...
                                                <span className="d-block fs-12 text-fixed-white">
                                                    ...
                                                    <span className="op-7">of work to reach today's goal</span>.
                                                </span>
                                            ...
                                            <div className="d-flex align-items-top justify-content-between">
                                                ...
                                                <div className="flex-fill ms-3">
                                                    ...
                                                    <div className="d-flex align-items-center justify-content-between mt-1">
                                                        <div>
                                                            <Link className="text-primary" to="#">Ver todo<i className="ti ti-arrow-narrow-right ms-2 fw-semibold d-inline-block"></i></Link>
                                                        </div>
                                                        <div className="text-end">
                                                            <p className="mb-0 text-success fw-semibold">+40%</p>
                                                            <span className="text-muted op-7 fs-11">este mes</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <Card.Body>
                                            <div className="d-flex align-items-top justify-content-between">
                                                ...
                                                <div className="flex-fill ms-3">
                                                    <div className="d-flex align-items-center justify-content-between flex-wrap">
                                                        <div>
                                                            <p className="text-muted mb-0">Total Ingresos</p>
                                                    ...
                                                    <div className="d-flex align-items-center justify-content-between mt-1">
                                                        <div>
                                                            <Link className="text-secondary" to="#">Ver todo<i className="ti ti-arrow-narrow-right ms-2 fw-semibold d-inline-block"></i></Link>
                                                        </div>
                                                        <div className="text-end">
