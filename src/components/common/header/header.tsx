    ...
    return (
        <Fragment>
            ...
            <Dropdown className="header-element notifications-dropdown" autoClose="outside">
              <Dropdown.Toggle variant="" className="header-link dropdown-toggle" data-bs-toggle="dropdown"
              ...
              <Dropdown.Menu align="end" className="main-header-dropdown dropdown-menu dropdown-menu-end"
                  ...
                  <div className="text-center">
                        ...
                        <Dropdown className="header-element header-profile">
                            <Dropdown.Toggle variant='' className="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="d-sm-block d-none">
                                        <p className="fw-semibold mb-0 lh-1">{auth.user?.nombre} {auth.user?.apellido}</p>
                                        <span className="op-7 fw-normal d-block fs-11"></span>
                                    </div>
                                </div>
                            </Dropdown.Toggle>
                            <Dropdown.Menu align="end" as="ul" className="main-header-dropdown  pt-0 overflow-hidden header-profile-dropdown" aria-labelledby="mainHeaderProfile">
                                ...
                                <Dropdown.Item className="d-flex" href="#" onClick={handleLogout}><i className="ti ti-logout fs-18 me-2 op-7"></i>Log Out</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                        <div className="header-element">
